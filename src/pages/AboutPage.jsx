  ...
  return (
    <div className="overflow-hidden" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <section
        ...
        style={{ background: 'linear-gradient(145deg, #f0eeff 0%, #fdf4ff 50%, #eef2ff 100%)' }}
      >
        {/* orbs */}
        <div className="orb absolute w-96 h-96 opacity-40 -top-32 -start-16"
          style={{ background: 'radial-gradient(circle, #c7d2fe, transparent)' }} />
        <div className="orb absolute w-80 h-80 opacity-25 -bottom-20 -end-16"
          style={{ background: 'radial-gradient(circle, #f5d0fe, transparent)', animationDelay: '3s' }} />
        {/* grid */}
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6">
          <div className="section-tag mx-auto mb-6 animate-fade-in">{t.hero.tag}</div>
          <h1
            className="font-heading font-extrabold text-slate-900 mb-6 leading-tight animate-slide-up"
            style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', animationDelay: '0.1s' }}
          >
            {t.hero.title}
          </h1>
          <p className="text-lg text-slate-500 leading-relaxed animate-slide-up max-w-2xl mx-auto"
