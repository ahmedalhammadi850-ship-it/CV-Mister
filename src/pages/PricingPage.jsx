...
const PricingPage = () => {
  ...
  const [pricing, setPricing] = useState(() => {
    try {
      const c = localStorage.getItem('cv_pricing');
  ...
  const plans = [
    {
      ...
      nameEn: pricing.free_name_en,
      desc: pricing.free_desc,
      descEn: pricing.free_desc_en,
      price: 0,
      period: 'شهرياً',
      periodEn: 'month',
      cta: 'ابدأ مجاناً',
    ...
    },
    {
      ...
      desc: pricing.pro_desc,
      descEn: pricing.pro_desc_en,
    ...
    },
    {
      ...
      desc: pricing.business_desc,
      descEn: pricing.business_desc_en,
