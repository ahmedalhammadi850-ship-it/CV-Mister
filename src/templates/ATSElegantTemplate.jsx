...
/**
 * ATS Elegant — centered name & centered bold section headings with a full-width rule below.
 * ATS rules:
 *   • No tables, no columns, no floats
 *   • Centered ALL-CAPS headings with solid rule underneath
 *   • Skills as plain text
 *   • No images, no icons, no decorative graphics
 */
const ATSElegantTemplate = ({
  ...
  const SectionHead = ({ label }) => (
    <>
      <div style={s.headingWrap}>
        <span style={s.headingText}>{label}</span>
      </div>
      <div style={s.rule} />
    </>
  );
